...
cordova platform add android & cordova build & cordova plugin add org.apache.cordova.console & cordova plugin add org.apache.cordova.device & cordova plugin add org.apache.cordova.inappbrowser & cordova plugin add https://github.com/kgillespieanaren/BluetoothLE.git & cordova run android -d
color 0f
